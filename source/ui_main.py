...
"}")
        ...
        self.loadReading_label.setStyleSheet("color: #fff; margin: 20; font: 15px \"arial black\"")
        ...
        self.jogDown_button.setStyleSheet("*{border: 4px solid \'#333\'; border-radius: 10px; font: bold 16px \"Arial Black\"; color: \'white\'; padding: 5px 5px; margin: 0px 0px; background: #555} *:hover{background: \'#369\';}")
        ...
        self.motorStatus_static_label.setStyleSheet("color: #fff; margin: 20; font: 15px \"arial black\"")
        ...
        self.loadStatus_static_label.setStyleSheet("color: #fff; margin: 20; font: 15px \"arial black\"")
        ...
        self.loadReading_static_label.setStyleSheet("color: #fff; margin: 20; font: 15px \"arial black\"")
        ...
        self.position_static_label.setStyleSheet("color: #fff; margin: 20; font: 15px \"arial black\"")
        ...
        self.positionReading_label.setStyleSheet("color: #fff; margin: 20; font: 15px \"arial black\"")
        ...
        self.loadStatus_label.setStyleSheet("color: #fff; margin: 20; font: 15px \"arial black\"")
        ...
        self.connectLoad_button.setStyleSheet("*{border: 4px solid \'#333\'; border-radius: 10px; font: bold 16px \"Arial Black\"; color: \'white\'; padding: 5px 5px; margin: 0px 0px; background: #555} *:hover{background: \'#369\';}")
        ...
        self.home_button_page1.setStyleSheet("*{border: 4px solid \'#333\'; border-radius: 10px; font: bold 16px \"Arial Black\"; color: \'white\'; padding: 5px 5px; margin: 0px 0px; background: #555} *:hover{background: \'#369\';}")
        ...
        self.jogdown_lineedit.setMaximumSize(QtCore.QSize(100, 30))
        self.jogdown_lineedit.setStyleSheet("border: 2px solid \'#ccc\'; border-radius: 5px; font-size: 18px; color: #fff; margin: 0 20")
        ...
        self.jogup_lineEdit.setMaximumSize(QtCore.QSize(100, 30))
        self.jogup_lineEdit.setStyleSheet("border: 2px solid \'#ccc\'; border-radius: 5px; font-size: 18px; color: #fff; margin: 0 20")
        ...
        self.connectMotor_button.setStyleSheet("*{border: 4px solid \'#333\'; border-radius: 10px; font: bold 16px \"Arial Black\"; color: \'white\'; padding: 5px 5px; margin: 0px 0px; background: #555} *:hover{background: \'#369\';}")
        ...
        self.jogUp_button.setStyleSheet("*{border: 4px solid \'#333\'; border-radius: 10px; font: bold 16px \"Arial Black\"; color: \'white\'; padding: 5px 5px; margin: 0px 0px; background: #555} *:hover{background: \'#369\';}")
        ...
        self.motorStatus_label.setStyleSheet("color: #fff; margin: 20; font: 15px \"arial black\"")
        ...
        self.stopButton_page1.setStyleSheet("*{border: 4px solid \'#222\'; border-radius: 10px; font: bold 16px \"Arial Black\"; color: \'white\'; padding: 5px 5px; margin: 0px 0px; background: #555} *:hover{background: \'#369\';}")
        ...
        self.jogup_comboBox.setMaximumSize(QtCore.QSize(16777215, 30))
        ...
        self.jogup_comboBox.setStyleSheet("QComboBox {border: 2px solid #ccc; border-radius: 7px; background-color: #333; margin-left: 20;;} QComboBox::drop-down { width: 40px; }")
        ...
        self.jogdown_comboBox.setMaximumSize(QtCore.QSize(200, 30))
        self.jogdown_comboBox.setStyleSheet("QComboBox {border: 2px solid #ccc; border-radius: 7px; background-color: #333; margin-left: 20;;} QComboBox::drop-down { width: 40px; }")
        ...
        self.flagStatus_static_label.setStyleSheet("color: #fff; margin: 20; font: 15px \"arial black\"")
        ...
        self.flag_reading_label.setStyleSheet("color: #fff; margin: 20; font: 15px \"arial black\"")
        ...
        self.layerCount_label.setStyleSheet("color: #fff; margin: 20; font: 18px \"arial black\"")
        self.layerCount_label.setObjectName("layerCount_label")
        self.gridLayout_2.addWidget(self.layerCount_label, 2, 0, 1, 1)
        ...
        self.layerAfter_label.setStyleSheet("color: #fff; margin: 20; font: 18px \"arial black\"")
        ...
        self.gridLayout_2.addWidget(self.layerCount_lineedit, 2, 1, 1, 1)
        self.layerBefore_label = QtWidgets.QLabel(self.page_2)
        self.layerBefore_label.setStyleSheet("color: #fff; margin: 20; font: 18px \"arial black\"")
        ...
        self.layerBeforeUnit_label.setStyleSheet("color: #fff; margin-left: 20; font: 15px \"arial black\"")
        ...
        self.layerAfterUnit_label.setStyleSheet("color: #fff; margin-left: 20; font: 15px \"arial black\"")
        ...
        self.sampleProgramButton.setStyleSheet("*{border: 4px solid \'#333\'; border-radius: 10px; font: bold 16px \"Arial Black\"; color: \'white\'; padding: 5px 5px; margin: 0px 0px; background: #555} *:hover{background: \'#369\';}")
        self.sampleProgramButton.setObjectName("sampleProgramButton")
        self.gridLayout_2.addWidget(self.sampleProgramButton, 3, 4, 1, 1)
        ...
        self.layerAfter_comboBox.setMaximumSize(QtCore.QSize(130, 30))
        self.layerAfter_comboBox.setFocusPolicy(QtCore.Qt.WheelFocus)
        self.layerAfter_comboBox.setStyleSheet("QComboBox {border: 2px solid #ccc; border-radius: 7px; background-color: #333; margin-left: 20; font: #fff} QComboBox::drop-down { width: 30px; }")
        ...
        self.layerBefore_comboBox.setMaximumSize(QtCore.QSize(130, 30))
        self.layerBefore_comboBox.setStyleSheet("QComboBox {border: 2px solid #ccc; border-radius: 7px; background-color: #333; margin-left: 20; font: #fff} QComboBox::drop-down { width: 30px; }")
        ...
        self.exportDataButton.setStyleSheet("*{border: 4px solid \'#333\'; border-radius: 10px; font: bold 16px \"Arial Black\"; color: \'white\'; padding: 5px 5px; margin: 0px 0px; background: #555} *:hover{background: \'#369\';}")
        self.exportDataButton.setObjectName("exportDataButton")
        self.gridLayout_2.addWidget(self.exportDataButton, 3, 1, 1, 1)
        ...
        self.startDataButton.setMaximumSize(QtCore.QSize(225, 16777215))
        self.startDataButton.setStyleSheet("*{border: 4px solid \'#333\'; border-radius: 10px; font: bold 14px \"Arial Black\"; color: \'white\'; padding: 5px 5px; margin: 0px 0px; background: #555} *:hover{background: \'#369\';}")
        self.startDataButton.setObjectName("startDataButton")
        self.horizontalLayout_4.addWidget(self.startDataButton)
        ...
        self.stopDataButton.setMaximumSize(QtCore.QSize(225, 16777215))
        self.stopDataButton.setStyleSheet("*{border: 4px solid \'#333\'; border-radius: 10px; font: bold 14px \"Arial Black\"; color: \'white\'; padding: 5px 5px; margin: 0px 0px; background: #555} *:hover{background: \'#369\';}")
        self.stopDataButton.setObjectName("stopDataButton")
        self.horizontalLayout_4.addWidget(self.stopDataButton)
        ...
        self.runButton_page2.setStyleSheet("*{border: 4px solid \'#333\'; border-radius: 10px; font: bold 16px \"Arial Black\"; color: \'white\'; padding: 5px 5px; margin: 0px 0px; background: #555} *:hover{background: \'#369\';}")
        self.runButton_page2.setObjectName("runButton_page2")
        self.verticalLayout_9.addWidget(self.runButton_page2)
        self.stopButton_page2 = QtWidgets.QPushButton(self.page_2)
        self.stopButton_page2.setStyleSheet("*{border: 4px solid \'#333\'; border-radius: 10px; font: bold 16px \"Arial Black\"; color: \'white\'; padding: 5px 5px; margin: 0px 0px; background: #555} *:hover{background: \'#369\';}")
        self.stopButton_page2.setObjectName("stopButton_page2")
        self.verticalLayout_9.addWidget(self.stopButton_page2)
        self.gridLayout_2.addLayout(self.verticalLayout_9, 2, 4, 1, 1)
