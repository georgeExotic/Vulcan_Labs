...
class Ui_MainWindow(QMainWindow):
    ...
    def runMotor(self):
        ...
        print(f'ilh: {motor.initLayerHeight}, compaction: {motor.compactedLayerHeight}, targPress: {motor.targetPressure}, #ofLayers: {motor.numberOfLayers}, mass: {motor.mass}, mode: {self.modeSelected}')
